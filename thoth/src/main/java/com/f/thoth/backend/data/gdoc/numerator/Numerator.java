...
public class Numerator
{
	 ...
	 */
	public synchronized Sequence getSequence(final Tenant tenant, final String nombre, final String prefijo, final String sufijo, final long inicial, final int incremento, final int longitud )
	{
		if ( tenant == null )
