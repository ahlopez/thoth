...
public class DataGenerator implements HasLogger {
   ...
   public void loadData() {
      ...
      ObjectToProtect obj05 = createObject( tenant1,    Constant.TITLE_INFORMACION                          , obj03);  // "Informaci�n";
      ObjectToProtect obj06 = createObject( tenant1,    Constant.TITLE_ROLES                                , obj03);  // "Roles";
      ObjectToProtect obj07 = createObject( tenant1,    Constant.TITLE_PERMISOS_EJECUCION                   , obj03);  // "Permisos de ejecuci�n";
      ObjectToProtect obj08 = createObject( tenant1,    Constant.TITLE_PERMISOS_ACCESO                      , obj03);  // "Permisos de acceso";
      ObjectToProtect obj09 = createObject( tenant1, Constant.TITLE_ADMINISTRACION                          , null );  // "Administraci�n";
      ObjectToProtect obj10 = createObject( tenant1,    Constant.TITLE_PARAMETROS                           , obj09);  // "Par�metros";
      ...
      ObjectToProtect obj13 = createObject( tenant1, Constant.TITLE_CLASIFICACION                           , null );  // "Clasificaci�n";
      ...
      ObjectToProtect obj19 = createObject( tenant1, Constant.TITLE_ADMIN_EXPEDIENTES                       , null );  // "Gesti�n expedientes";
      ...
      ObjectToProtect obj22 = createObject( tenant1,    Constant.TITLE_VOLUMENES                            , obj19);  // "Vol�menes";
      ObjectToProtect obj23 = createObject( tenant1,    Constant.TITLE_INDICE                               , obj19);  // "�ndice de expedientes";
      ObjectToProtect obj24 = createObject( tenant1,    Constant.TITLE_EXPORTACION                          , obj19);  // "Exportaci�n de expedientes";
      ObjectToProtect obj25 = createObject( tenant1,    Constant.TITLE_IMPORTACION                          , obj19);  // "Importaci�n de expedientes";
      ...
      ObjectToProtect obj30 = createObject( tenant1,    Constant.TITLE_CLASIFICACION_DOCUMENTOS             , obj28);  // "Clasificaci�n de documento";
      ObjectToProtect obj31 = createObject( tenant1,    Constant.TITLE_RETORNO                              , obj28);  // "Devoluci�n de documento";
      ObjectToProtect obj32 = createObject( tenant1,    Constant.TITLE_RE_ENVIO                             , obj28);  // "Re-env�o de documento";
      ...
      ObjectToProtect obj35 = createObject( tenant1,    Constant.TITLE_ENVIO                                , obj28);  // "Ordena env�o de documento";
      ObjectToProtect obj36 = createObject( tenant1, Constant.TITLE_RECEPCION                               , null );  // "Recepci�n de documentos";
      ObjectToProtect obj37 = createObject( tenant1,    Constant.TITLE_RECEPCION_DOCUMENTOS                 , obj36);  // "Recepci�n en ventanilla";
      ObjectToProtect obj38 = createObject( tenant1,    Constant.TITLE_RECEPCION_E_MAIL                     , obj36);  // "Recepci�n correo electr�nico";
      ObjectToProtect obj39 = createObject( tenant1,    Constant.TITLE_DIGITALIZACION                       , obj36);  // "Digitalizaci�n";
      ObjectToProtect obj40 = createObject( tenant1,    Constant.TITLE_DIRECCIONAMIENTO                     , obj36);  // "Enrutamiento de documentos";
      ObjectToProtect obj41 = createObject( tenant1, Constant.TITLE_CORRESPONDENCIA_EXTERNA                 , null );  // "Env�o de documentos";
      ObjectToProtect obj42 = createObject( tenant1,    Constant.TITLE_REGISTRO_ENVIOS                      , obj41);  // "Consolidaci�n env�os externos";
      ObjectToProtect obj43 = createObject( tenant1,    Constant.TITLE_ENVIO_EXTERNO                        , obj41);  // "Env�a correspondencia externa";
      ObjectToProtect obj44 = createObject( tenant1,    Constant.TITLE_CONFIRMACION_ENVIO                   , obj41);  // "Confirmaci�n de recepci�n";
      ...
      ObjectToProtect obj48 = createObject( tenant1,       Constant.TITLE_CONSULTA_METADATOS                , obj46);  // "Consulta documentos seg�n metadatos";
      ObjectToProtect obj49 = createObject( tenant1,    Constant.TITLE_CONSULTA_EXPEDIENTES                 , obj45);  // "Consulta de expedientes";
      ObjectToProtect obj50 = createObject( tenant1,       Constant.TITLE_CONSULTA_EXPEDIENTES_LIBRE        , obj49);  // "Consulta de expedientes seg�n texto libre";
      ObjectToProtect obj51 = createObject( tenant1,       Constant.TITLE_CONSULTA_EXPEDIENTES_METADATOS    , obj49);  // "Consulta de expedientes seg�n metadatos";
      ObjectToProtect obj52 = createObject( tenant1,       Constant.TITLE_CONSULTA_EXPEDIENTES_CLASIFICACION, obj49);  // "Consulta de expedientes seg�n clasificaci�n";
      ObjectToProtect obj53 = createObject( tenant1, Constant.TITLE_PROCESOS                                , null );  // "Procesos";
      ObjectToProtect obj54 = createObject( tenant1,    Constant.TITLE_EJECUCION_PROCESO                    , obj53);  // "Ejecuci�n de proceso";
      ObjectToProtect obj55 = createObject( tenant1,    Constant.TITLE_DEFINICION_PROCESO                   , obj53);  // "Definici�n de proceso";
      ...
      ObjectToProtect obj58 = createObject( tenant1,    Constant.TITLE_TRANSFERENCIA                        , obj56);  // "Preparaci�n de transferencia";
      ObjectToProtect obj59 = createObject( tenant1,    Constant.TITLE_RECIBO_TRANSFERENCIA                 , obj56);  // "Recepci�n de transferencia";
      ObjectToProtect obj60 = createObject( tenant1,    Constant.TITLE_LOCALIZACION                         , obj56);  // "Localizaci�n de documentos";
      ObjectToProtect obj61 = createObject( tenant1,    Constant.TITLE_PRESTAMO                             , obj56);  // "Pr�stamos";
      ObjectToProtect obj62 = createObject( tenant1,       Constant.TITLE_PRESTAMO_EXPEDIENTE               , obj61);  // "Pr�stamo de expedientes";
   ...
   private ObjectToProtect createObject( Tenant tenant, String name, ObjectToProtect owner)
   {
      ...
      objectToProtectRepository.saveAndFlush(obj);
      return obj;
   }//createObject
