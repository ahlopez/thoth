...
public class ClassificationGenerator implements HasLogger
{
	...
	private void createSequence(Tenant tenant, Classification classificationClass)
	{
		int    year      = LocalDateTime.now().getYear();
		String classCode = classificationClass.getCode();
		String seqCode   = classCode.substring( classCode.lastIndexOf("/")+1);
		seqCode          = TextUtil.pad(seqCode , 3);
