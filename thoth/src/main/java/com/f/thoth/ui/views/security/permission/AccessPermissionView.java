...
public class AccessPermissionView extends AbstractPermissionView<ClassificationClass>
{
   @Autowired
   public AccessPermissionView( PermissionService<ClassificationClass> service, CurrentUser currentUser)
   {
      super(ClassificationClass.class, service, currentUser, Constant.TITLE_PERMISOS_ACCESO);
   }
