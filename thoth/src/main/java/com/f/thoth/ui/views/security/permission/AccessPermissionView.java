...
public class AccessPermissionView extends AbstractPermissionView<ObjectToProtect>
{
   @Autowired
   public AccessPermissionView( PermissionService<ObjectToProtect> service, CurrentUser currentUser)
   {
      super(ObjectToProtect.class, service, currentUser, Constant.TITLE_PERMISOS_ACCESO);
   }
