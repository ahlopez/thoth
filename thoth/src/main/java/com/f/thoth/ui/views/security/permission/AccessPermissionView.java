...
{
   @Autowired
   public AccessPermissionView( PermissionService<Classification> service, CurrentUser currentUser)
   {
      super(Classification.class, service, currentUser, Constant.TITLE_PERMISOS_ACCESO);
   }
